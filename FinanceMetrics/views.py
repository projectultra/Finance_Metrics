...
def DisplayStock(request):
    ...
    context = {'METAstock': float(METAstock.predicted_price),
                   ...
                   'NFLXstock': float(NFLXstock.predicted_price),
                   'GOOGstock': float(GOOGstock.predicted_price),
                   'MSFTstock': float(MSFTstock.predicted_price),
                   'TSLAstock': float(TSLAstock.predicted_price),}
